...
const steps = [
  {
    ...
    desc: "Peu importe où tu vis en France ou dans le monde : on se retrouve régulièrement en Zoom pour échanger, se motiver et grandir ensemble. Aucune bâtisseuse laissée à distance.",
    accent: "from-fuchsia-500 to-purple-500",
  },
  {
    icon: Coffee,
    tag: "Ce trimestre",
    title: "Cafés IRL à Bordeaux",
    desc: "On démarre en présentiel dans ma ville. Un café bienveillant, du vrai networking, zéro discours vide. Juste se voir en vrai — parce que c'est ça qui change tout.",
  ...
  },
  {
    ...
    desc: "Mon ambition : que Les Bâtisseuses devienne un mouvement national. Des cafés dans chaque ville de France, portés par des membres motivées. Tu veux organiser dans ta ville ? Écris-moi.",
